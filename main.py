...
for i in range(8, 13):
  raw_data = pd.read_csv("ow-lol-pubg-csgo/new_2018_{:02d}.csv".format(i))
  ...
  # raw_dota_data = raw_data[raw_data.subreddit == 'DotA2'].head(200)
  # raw_gta_data = raw_data[raw_data.subreddit == 'GrandTheftAutoV'].head(200)
  # raw_tf_data = raw_data[raw_data.subreddit == 'tf2'].head(200)

  raw_data = pd.concat([raw_ow_data, raw_lol_data, raw_pubg_data, raw_csgo_data])
  # raw_data = pd.concat([raw_dota_data, raw_gta_data, raw_tf_data])
